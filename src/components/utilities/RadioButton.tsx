...
const RadioButton = ({
  ...
  const isGroupChecked = isGrop && context.value !== undefined ? !!(value ?? children === context.value) : undefined;

  const handleGroupChange = () => context.onChange && context.onChange(value ?? children);
