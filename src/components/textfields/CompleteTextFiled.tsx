...
import WEdit from '@assets/icons/wght400/WEdit.svg';
...
const CompleteTextFiled = ({onClick, children, disabled = false, buttonTestId}: CompleteTextFiledProps) => {
  return (
    <CompleteTextFiledWrapper disabled={disabled}>
      ...
      {!disabled && <IconButton onClick={onClick} IconComponent={WEdit} ariaLabel="edit" testId={buttonTestId} />}
