...
type BackgroundImageCardWrapperProps = Pick<BackgroundImageCardProps, 'imgPath'>;
...
const BackgroundImageCard = ({imgPath, children}: BackgroundImageCardProps) => {
  return <BackgroundImageCardWrapper imgPath={imgPath}>{children}</BackgroundImageCardWrapper>;
};
